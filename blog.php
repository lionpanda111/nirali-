...
try {
    ...
    $total_posts = $db->query("SELECT COUNT(*) FROM blog_posts WHERE status = 'published' AND (published_at IS NULL OR published_at <= NOW())")->fetchColumn();
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <p class="lead text-muted">Discover the latest makeup tips, trends, and beauty secrets</p>
            </div>
        </div>
    </div>
</header>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <?php elseif (empty($posts)): ?>
                    <div class="alert alert-info">No blog posts found. Please check back later!</div>
                <?php else: ?>
                    <div class="row g-4">
